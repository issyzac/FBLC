...
public class FrontRecyclerAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder> {

    private List<Sermon> items;

    public FrontRecyclerAdapter(List<Sermon> datamodel){
        if (datamodel == null){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType){
        ...
        if (viewType == VIEW_TYPE_HEADER){
            ...
            return new ListViewHeaderViewHolder(itemView);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int itemPosition){
        ...
        if (viewHolder instanceof ListViewItemViewHolder){
